...
public class DashboardController {
    ...
    @Value("${ecovisionschool.pageSize}")
    private int defaultPageSize;

    @Value("${ecovisionschool.contact.successMsg}")
    ...
    public String displayDashboard(Model model,Authentication authentication, HttpSession session) {
        ...
        if(null != person.getEcoVisionClass() && null != person.getEcoVisionClass().getName()){
            model.addAttribute("enrolledClass", person.getEcoVisionClass().getName());
        }
    ...
    private void logMessages() {
        ...
        log.error("defaultPageSize value with Environment is : "+environment.getProperty("ecovisionschool.pageSize"));
        log.error("successMsg value with Environment is : "+environment.getProperty("ecovisionschool.contact.successMsg"));
